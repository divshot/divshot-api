...
var Divshot = function (options) {
  this.defaults = {
    proxyServer: process.env.HTTPS_PROXY || process.env.https_proxy || process.env.HTTP_PROXY || process.env.http_proxy
  };
  ...
  this.apps = apps(this._api, this, options);
  this.builds = builds(this._api, this, options);
  this.releases = releases(this._api, this, options);
  this.organizations = organizations(this._api, this);
  this.vouchers = vouchers(this._api, this, options);
};
